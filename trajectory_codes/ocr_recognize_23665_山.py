...
STROKE_COUNT = 3
TOTAL_TIME = 1.900
BOUNDING_BOX = (0.2, 0.1, 0.8, 0.6)

TRAJECTORY_DATA = [
    # Stroke 1
    [
        Point(0.200, 0.100, 0.800, 0.000, 1.000),
        Point(0.200, 0.600, 0.900, 0.500, 1.000),
    ],
    # Stroke 2
    [
        Point(0.500, 0.100, 0.800, 0.700, 1.000),
        Point(0.500, 0.600, 0.900, 1.200, 1.000),
    ],
    # Stroke 3
    [
        Point(0.800, 0.100, 0.800, 1.400, 1.000),
        Point(0.800, 0.600, 0.900, 1.900, 1.000),
    ],
]
...
def recognize_character_23665(features, stroke_analysis):
    """識別字符 '山' 的專門函數"""
...
def main():
    ...
    # 字符識別
    predicted_char, confidence = recognize_character_23665(features, stroke_analysis)
